...
func (r ApiGetOrgSettingsRequest) Execute() (*Org, *http.Response, error) {
...
//  @return Org
func (a *OrgApiService) GetOrgSettingsExecute(r ApiGetOrgSettingsRequest) (*Org, *http.Response, error) {
	var (
...
func (r ApiUpdateOrgSettingsRequest) OrgEto(orgEto OrgEto) ApiUpdateOrgSettingsRequest {
	r.orgEto = &orgEto
	return r
}

func (r ApiUpdateOrgSettingsRequest) Execute() (*Org, *http.Response, error) {
...
// Execute executes the request
//  @return Org
func (a *OrgApiService) UpdateOrgSettingsExecute(r ApiUpdateOrgSettingsRequest) (*Org, *http.Response, error) {
	var (
	...
	localVarFormParams := url.Values{}
	if r.orgEto == nil {
		return localVarReturnValue, nil, reportError("orgEto is required and must be specified")
	}
