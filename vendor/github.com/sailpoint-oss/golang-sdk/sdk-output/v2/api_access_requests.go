...
// Paging offset.
func (r ApiListAccessRequestsRequest) Offset(offset int32) ApiListAccessRequestsRequest {
	r.offset = &offset
	return r
}
...
/*
ListAccessRequests Lists the access request for an identity.

Lists both the pending and past access requests for an identity.
...
func (a *AccessRequestsApiService) ListAccessRequestsExecute(r ApiListAccessRequestsRequest) ([]AccessRequest, *http.Response, error) {
	var (
